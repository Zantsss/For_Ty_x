document.addEventListener("DOMContentLoaded", function () {
    ...
    for (let y = 1; y <= 18; y++) {
        for (let x = 1; x <= 18; x++) {
            ...
            if (answers[positionKey]) {
                ...
                input.dataset.answer = answers[positionKey];
    ...
    pauseButton.addEventListener("click", function () {
        ...
        document.getElementById("crossword").style.pointerEvents = "none";
    });
    ...
    resumeButton.addEventListener("click", function () {
        ...
        document.getElementById("crossword").style.pointerEvents = "auto";
    });
    ...
    checkButton.addEventListener("click", function () {
        ...
        if (allCorrect) {
            ...
            resultDisplay.style.color = "#911919";
        }
    });
});
